...
// Apps (restricted to ROLE_ADMIN and ROLE_USER)
{
  ...
  children: [
      ...
      {path: 'guide', loadChildren: () => import('app/modules/admin/apps/help-center/datatable/datatable.routes')},

      // Uncomment and apply the same guard to other apps as needed
        ...
        // ]},
            ...
            // Documentation
            {
              ...
              children: [
                  ...
                  // Guides (commented out, can be added back if needed)
                  // {
                  //     path: 'guides',
                  //     loadChildren: () => import('app/modules/admin/docs/guides/guides.routes')
                  // }
              ]
          },
